...
class WebActivity extends CI_Controller
{
    public function index()
    {
        ...
        $sql = "SELECT * FROM gActivity WHERE  user_id=".$user_id;
    ...
    public function add() {
        ...
        //if ($result['loginState'] === Constants::S_AUTH) {
            DB::insert('gActivity', compact('user_id', 'name','logo_url','logo_v_url','tagline', 'introduction', 'start_date','end_date', 'user_num_limit', 'content', 'group_id', 'create_time'));
    ...
    public function update() {
        ...
        $res = DB::update('gActivity', compact('user_id', 'name','logo_url','logo_v_url','tagline', 'introduction', 'start_date','end_date', 'user_num_limit', 'content', 'group_id'),compact('id'));
